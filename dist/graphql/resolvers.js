...
export const resolvers = {
  ...
  Mutation: {
    ...
    updateChatRoomMessage: async (
      _,
      { hotelId, userId, messageId, updates },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    addChatToHotel: async (
      _,
      { hotelId, chat }, // TODO: Define Chat type in types.ts
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    updateChatFromHotel: async (
      _,
      { hotelId, userId, updates }, // TODO: Replace 'any' with Chat type
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    updateHousekeepingItem: async (
      _,
      { hotelId, category, itemId, updates },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    updateFeedbackCategoryItem: async (
      _,
      { feedbackId, field, itemId, updates },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    addMessageToSupportChatRoom: async (
      _,
      { supportId, message }, // TODO: Define SupportChatRoomMessage type in types.ts
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    updateSupportChatRoomMessage: async (
      _,
      { supportId, messageId, updates }, // TODO: Define SupportChatRoomMessage type
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    sendCheckInEmail: async (
      _,
      { senderEmail, email, appLink, logo, hotelName },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    sendCheckOutEmail: async (
      _,
      { senderEmail, email, logo, hotelName },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    sendNewCoworkerAccountEmail: async (
      _,
      { senderEmail, email, adminName, mshLogo, coworkerName, coworkerMail },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
    ...
    sendWelcomeEmail: async (
      _,
      { senderEmail, email, prospectName, prospectMail, mshLogo, mshLogoPro },
      context
    ) => {
      if (!context.user) {
        throw new Error('Unauthorized');
